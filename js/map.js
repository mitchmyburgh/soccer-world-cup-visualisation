...
function cleanMapF () {
  world.updateChoropleth({
   //champ and host
    URY: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span><span class='icon-soccer-court'></span>Hosted once: 1930 <br> <span class='icon-trophy'></span><span class='icon-trophy'></span>Won twice: 1930, 1950", flag: '../data/flags/uy.png'},
    ...
    CHL: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted once: 1962", flag: '../data/flags/cl.png'},
    ...
    COL: { fillKey: "defaultFill", text: "Never <span class='icon-trophy'></span>Won and never <span class='icon-soccer-court'></span>Hosted", flag: '../data/flags/co.png'},
...
//asia australasia
    RUS: { fillKey: "defaultFill", text: "Never <span class='icon-trophy'></span>Won and never <span class='icon-soccer-court'></span>Hosted", flag: '../data/flags/ru.png'},
  ...
  PRT: { fillKey: "defaultFill", text: "Never <span class='icon-trophy'></span>Won and never <span class='icon-soccer-court'></span>Hosted", flag: '../data/flags/pt.png'},
  ...
  POL: { fillKey: "defaultFill", text: "Never <span class='icon-trophy'></span>Won and never <span class='icon-soccer-court'></span>Hosted", flag: '../data/flags/pl.png'},
  ...
  HRV: { fillKey: "defaultFill", text: "Never <span class='icon-trophy'></span>Won and never <span class='icon-soccer-court'></span>Hosted", flag: '../data/flags/hr.png'},
...
function Participants(year) {
 world.updateChoropleth({
	URY: { fillKey: "championAndHost", text: "<span class='icon-soccer-court'></span>Hosted: 1930 <br> <span class='icon-trophy'></span>Won twice: 1930", flag: '../data/flags/uy.png'},

	ARG: { fillKey: "finalist", text: "<span class='icon-soccer-court'></span>Hosted once: 1978 <br> <span class='icon-trophy'></span>Won twice: 1978, 1986", flag: '../data/flags/ar.png'},
	USA: { fillKey: "semifinalist", text: "<span class='icon-soccer-court'></span>Hosted once: 1994", flag: '../data/flags/us.png'},
