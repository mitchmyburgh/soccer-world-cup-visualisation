var cleanMap = {
   //champ and host
    URY: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted once: 1930 (<span class='fa fa-users'></span>590,549) <br> <span class='icon-trophy'></span>Won twice: 1930, 1950 <br> <span class='icon-soccer-shoe'></span>Top Player: Diego Forlan(2010)", flag: '../data/flags/uy.png'},
    ITA: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted twice: 1934(<span class='fa fa-users'></span>363,000), 1990(<span class='fa fa-users'></span>) <br> <span class='icon-trophy'></span>Won 4 Times: 1934, 1938, 1982, 2006<br> <span class='icon-soccer-shoe'></span>Top Player: Salvitore Sillacci(1982), Paolo Rossi 1990", flag: '../data/flags/it.png'},
    FRA: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted twice: 1938(<span class='fa fa-users'></span>375,700), 1998(<span class='fa fa-users'></span>2,785,100) <br> <span class='icon-trophy'></span>Won once: 1998<br> <span class='icon-soccer-shoe'></span>Top Player: Thierry Henry(1958)", flag: '../data/flags/fr.png'},
    BRA: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted twice: 1950(<span class='fa fa-users'></span>1,045,246), 2014(<span class='fa fa-users'></span>3,429,873) <br> <span class='icon-trophy'></span>Won 5 times: 1958, 1962, 1970, 1994, 2002 <br> <span class='icon-soccer-shoe'></span>Top Player: Leonidas(1938), Ademir(1950), Garrincha and Vava(1962), Ronaldo(2002)", flag: '../data/flags/br.png'},
    DEU: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted twice: 1974(<span class='fa fa-users'></span>1,865,753), 2006(<span class='fa fa-users'></span>3,359,439) <br> <span class='icon-trophy'></span>Won 4 times: 1954, 1974, 1990, 2014<br> <span class='icon-soccer-shoe'></span>Top Player:Gert Mueller(1970), Miroslav Klose(2006),Thomas Mueller(2010)", flag: '../data/flags/de.png'},
    ARG: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted once: 1978(<span class='fa fa-users'></span>1,545,791) <br> <span class='icon-trophy'></span>Won twice: 1978, 1986 <span class='icon-soccer-shoe'></span>Top Player: Guillermo Stabile(1930), Mario Kempes(1978)", flag: '../data/flags/ar.png'},
    ESP: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted once: 1982(<span class='fa fa-users'></span>2,109,723) <br> <span class='icon-trophy'></span>Won once: 2010<br> <span class='icon-soccer-shoe'></span>Top Player: David Villa(2010)", flag: '../data/flags/es.png'},
    GBR: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted once: 1966(<span class='fa fa-users'></span>1,563,135) <br> <span class='icon-trophy'></span>Won once: 1966<br> <span class='icon-soccer-shoe'></span>Top Player: Gary Linneker(1986)", flag: '../data/flags/gb.png'},

    //hosts
    USA: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted once: 1994(<span class='fa fa-users'></span>363,000)", flag: '../data/flags/us.png'},
    MEX: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted twice: 1970(<span class='fa fa-users'></span>1,603,975), 1986(<span class='fa fa-users'></span>2,394,031)", flag: '../data/flags/mx.png'},
    CHE: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted once: 1954(<span class='fa fa-users'></span>768,607)", flag: '../data/flags/ch.png'},
    SWE: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted once: 1958(<span class='fa fa-users'></span>819,810)", flag: '../data/flags/se.png'},
    CHL: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted once: 1962(<span class='fa fa-users'></span>893,172)<br> <span class='icon-soccer-shoe'></span>Top Player: Alexis Sanchez(1962)", flag: '../data/flags/cl.png'},
    KOR: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted once: 2002(<span class='fa fa-users'></span>2,705,197)", flag: '../data/flags/kr.png'},
    JPN: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted once: 2002(<span class='fa fa-users'></span>2,705,197)", flag: '../data/flags/jp.png'},
    ZAF: { fillKey: "defaultFill", text: "<span class='icon-soccer-court'></span>Hosted once: 2010(<span class='fa fa-users'></span>3,178,856)", flag: '../data/flags/za.png'},
...
//asia australasia
  ...
  MNE: { fillKey: "defaultFill", text: "Never <span class='icon-trophy'></span>Won and never <span class='icon-soccer-court'></span>Hosted", flag: '../data/flags/me.png'},
  ISR: { fillKey: "defaultFill", text: "Never <span class='icon-trophy'></span>Won and never <span class='icon-soccer-court'></span>Hosted", flag: '../data/flags/il.png'},
  IRN: { fillKey: "defaultFill", text: "Never <span class='icon-trophy'></span>Won and never <span class='icon-soccer-court'></span>Hosted", flag: '../data/flags/ir.png'},
  KWT: { fillKey: "defaultFill", text: "Never <span class='icon-trophy'></span>Won and never <span class='icon-soccer-court'></span>Hosted", flag: '../data/flags/kw.png'},
  DNK: { fillKey: "defaultFill", text: "Never <span class='icon-trophy'></span>Won and never <span class='icon-soccer-court'></span>Hosted", flag: '../data/flags/dk.png'},
  IRQ: { fillKey: "defaultFill", text: "Never <span class='icon-trophy'></span>Won and never <span class='icon-soccer-court'></span>Hosted", flag: '../data/flags/iq.png'},
  IRL: { fillKey: "defaultFill", text: "Never <span class='icon-trophy'></span>Won and never <span class='icon-soccer-court'></span>Hosted", flag: '../data/flags/ie.png'},
  ARE: { fillKey: "defaultFill", text: "Never <span class='icon-trophy'></span>Won and never <span class='icon-soccer-court'></span>Hosted", flag: '../data/flags/ae.png'},
  SAU: { fillKey: "defaultFill", text: "Never <span class='icon-trophy'></span>Won and never <span class='icon-soccer-court'></span>Hosted", flag: '../data/flags/sa.png'},
...
//asia australasia
  ...
  //countries we forgot
  {country: "MNE", fillKey: "defaultFill"},
